...
export const SmartFeatures = () => {
  ...
  return (
    <Container as="section" ref={containerRef} className="flex flex-col gap-6 py-[40px] md:py-[60px]">
      {/* Section Header */}
      <div ref={headerRef} className="mx-auto max-w-3xl space-y-4 text-center">
      ...
      <div ref={gridRef} className="grid grid-cols-1 gap-[24px] md:grid-cols-2 lg:grid-cols-4">
        {/* Card 1: Wide */}
        <div className="group relative col-span-1 flex min-h-[320px] flex-col justify-between overflow-hidden rounded-[24px] border border-white/10 bg-linear-to-b from-[#3A3A3A] to-[#1F1F1F] p-6 transition-all hover:border-white/20 md:col-span-2 lg:col-span-2">
          ...
          <div className="relative z-10 mb-[24px] flex flex-1 items-center justify-center">
            ...
            <div className="relative flex h-[180px] w-full items-center justify-between px-[20px]">
              ...
              <div className="absolute inset-0 z-0 flex items-center justify-center">
                <div className="h-[2px] w-[60%] bg-linear-to-r from-transparent via-[#4A4A4A] to-transparent"></div>
        ...
        {/* Card 2: Narrow */}
        <div className="group relative col-span-1 flex min-h-[320px] flex-col justify-between overflow-hidden rounded-[24px] border border-white/10 bg-linear-to-b from-[#3A3A3A] to-[#1F1F1F] p-6 transition-all hover:border-white/20">
        ...
        {/* Card 3: Narrow */}
        <div className="group relative col-span-1 flex min-h-[320px] flex-col justify-between overflow-hidden rounded-[24px] border border-white/10 bg-linear-to-b from-[#3A3A3A] to-[#1F1F1F] p-6 transition-all hover:border-white/20">
          <div className="absolute inset-x-0 top-0 h-[100px] bg-linear-to-b from-black/20 to-transparent"></div>
        ...
        {/* Card 4: Narrow */}
        <div className="group relative col-span-1 flex min-h-[320px] flex-col justify-between overflow-hidden rounded-[24px] border border-white/10 bg-linear-to-b from-[#3A3A3A] to-[#1F1F1F] p-6 transition-all hover:border-white/20">
          <div className="absolute inset-y-0 left-1/2 w-px -translate-x-1/2 bg-linear-to-b from-transparent via-white/10 to-transparent"></div>
          <div className="relative z-10 mb-[24px] flex flex-1 items-center justify-center">
        ...
        <div className="group relative col-span-1 flex min-h-[320px] flex-col justify-between overflow-hidden rounded-[24px] border border-white/10 bg-linear-to-b from-[#3A3A3A] to-[#1F1F1F] p-6 transition-all hover:border-white/20">
          ...
          <div className="relative z-10 mb-[24px] flex flex-1 flex-col items-center justify-center gap-[40px]">
            ...
            <div className="relative flex w-full items-center justify-center">
              <div className="absolute inset-x-0 h-px border-t border-dashed border-white/20"></div>
              <div className="z-10 rounded-full border border-white/10 bg-black px-[24px] py-[8px] shadow-[0_0_20px_rgba(255,255,255,0.1)]">
                <div className="h-[8px] w-[8px] rounded-full bg-white"></div>
              </div>

              {/* Glowing Dot */}
              <div className="absolute top-1/2 left-[30%] h-[12px] w-[12px] -translate-y-1/2 rounded-full bg-blue-500 blur-xs"></div>
            </div>
          </div>
          <h3 className="z-10 mt-auto text-center text-[18px] font-semibold text-white/90">
            ...
            <div className="relative mt-[40px] h-[200px] w-[300px]">
              ...
              <div className="absolute inset-x-0 bottom-0 h-[100px]">
                <div className="clip-path-polygon-[0_100%,50%_0,100%_100%] flex h-full w-full items-center justify-center rounded-[12px] rounded-b-none border-t border-t-white/10 bg-[#2A2A2A] shadow-[0_-10px_30px_rgba(0,0,0,0.5)]">
                  <div className="h-0 w-0 border-r-150 border-b-100 border-l-150 border-r-transparent border-b-[#1A1A1A] border-l-transparent"></div>
                </div>
              </div>
            </div>
          </div>
