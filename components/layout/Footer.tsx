...
export function Footer() {
  ...
  return (
    <footer
      ref={footerRef}
      className="relative w-full overflow-hidden border-t border-white/5 bg-sales-bg pt-16 pb-8 font-almarai md:pt-24 lg:pt-32"
    >
      {/* Premium Background Glows */}
      <div className="pointer-events-none absolute top-0 left-1/2 h-[400px] w-full -translate-x-1/2 rounded-full bg-sales-purple/10 opacity-20 blur-[150px]" />
      <div className="pointer-events-none absolute -right-24 -bottom-24 h-[500px] w-[500px] rounded-full bg-sales-accent/10 opacity-10 blur-[150px]" />
      ...
      <Container className="relative z-10">
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-12">
          ...
          <div className="footer-line lg:col-span-4">
            ...
            <p className="max-w-[340px] text-[15px] leading-[1.8] text-white/50">
              ...
              النمو من خلال أتمتة المحادثات وتحويل الزوار إلى عملاء دائمين بأحدث
          ...
          <div className="footer-line grid grid-cols-2 gap-8 md:grid-cols-2 lg:col-span-5 lg:pl-12">
            <div>
              <h4 className="mb-6 text-[16px] font-bold tracking-wide text-white">
                روابط سريعة
              </h4>
              <ul className="flex flex-col gap-4">
                {[
                  ...
                  <li key={i} className="footer-link">
                    <Link
                      href="#"
                      className="group flex items-center gap-2 text-[14px] text-white/40 transition-colors duration-300 hover:text-white"
                    >
          ...
          <div className="footer-line lg:col-span-3">
            <div className="rounded-[24px] border border-white/5 bg-white/2 p-6 backdrop-blur-xl">
              <h4 className="mb-3 text-[16px] font-bold text-white">
                النشرة البريدية
              </h4>
              <p className="mb-6 text-[13px] leading-relaxed text-white/40">
                انضم إلى أكثر من 5000 علامة تجارية تثق بنا واحصل على آخر
                التحديثات.
              </p>
              <div className="space-y-3">
                <input
                  ...
                  className="h-12 w-full rounded-xl border border-white/10 bg-white/5 px-4 text-sm text-white transition-all outline-none focus:border-sales-purple/50 focus:ring-1 focus:ring-sales-purple/20"
                />
        ...
        {/* Lower Bar */}
        <div className="flex flex-col-reverse items-center justify-between gap-6 py-2 md:flex-row">
          <p className="text-[13px] text-white/50">
            © 2026 تم التطوير بواسطة{" "}
            <span className="text-white/80">سيرف 5</span>. جميع الحقوق محفوظة لـ{" "}
            <span className="font-bold text-white/80">سيلزاوي</span>
          </p>

          <div className="flex items-center gap-8">
            <Link
              href="#"
              className="text-[12px] text-white/20 transition-colors duration-300 hover:text-white/60"
            >
              English Version
            </Link>
